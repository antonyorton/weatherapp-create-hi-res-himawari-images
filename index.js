//AWS lambda function - working (production) on 27 July 2024
...
async function handler(event) {
  try {
    await create_composite((imsize = event.image_size), (local_env = event.local_env))
...
// handler({ image_size: '4d', local_env: true })
